...
class apiPhilanthropist{
    ...
    static async savePhilanthropist(data) {
        try {
            ...
            const response = await fetch('https://studentdesk.azurewebsites.net/api/Philanthropist/save', {
                method: 'POST',
                headers: {
     ...
     static async signInPhilanthropist (data) {
        try {
            ...
            const response = await fetch('https://studentdesk.azurewebsites.net/api/Philanthropist/authenticate', {
                method: 'POST',
                headers: {
                'Content-Type': 'application/json',
                },
      ...
      static async getProfile (data) {
        try {
            ...
            const response = await fetch('https://studentdesk.azurewebsites.net/api/Philanthropist/profile', {
                method: 'GET',
                headers: {
                'Content-Type': 'application/json',
